  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        ctx.filter = "none";
        // Prefer WebP at 85% quality (smaller payloads, fewer compression artefacts);
        // the server upload allowlist + magic-byte check already accept .webp.
        // Browsers that ignore the WebP MIME return PNG/JPEG, so fall back to JPEG.
